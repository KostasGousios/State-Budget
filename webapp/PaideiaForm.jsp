...
<head>
    <title>Υπουργείο Παιδείας - GOV-Budget</title>
...
<body class="paideia">
    ...
    <main class="main-content">
        <div class="about-platform">
            <div class="form-header">
                ...
                <h1>Φόρμα Υπουργείου Παιδείας</h1>
                <p>Συμπληρώστε τα παρακάτω πεδία για την αίτηση και διανομή εκπαιδευτικών κονδυλίων</p>
            </div>

            <div class="info-box">
                <p><strong>Πληροφορίες:</strong> Συμπληρώστε τα παρακάτω πεδία για την αίτηση και διανομή
                    κονδυλίων στον τομέα Παιδείας</p>
            </div>

            <form id="paideiaForm" method="POST">
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="zitoumenoPoso" name="zitoumenoPoso" required min="0" step="1000"
                            placeholder="Εισάγετε το ποσό που ζητάτε" class="form-control">
                    </div>
                </div>
                ...
                <div class="form-section">
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" id="diatesimoPoso" name="diatesimoPoso" required min="0" step="1000"
                            placeholder="Το ποσό που έχετε στη διάθεσή σας" class="form-control">
                    </div>
                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const form = document.getElementById('paideiaForm');
            ...
            if (form) {
                form.addEventListener('submit', function(event) {
                    ...
                    localStorage.setItem('paideia_form_data', JSON.stringify(formData));
